...
class AutoCode {
    public static void main(String[] args) {
        ...
        globalConfig
                .setOutputDir(projectPath + "/demo10/src/main/java")// 输出文件路径
        ...
        dataSourceConfig
                .setUrl("jdbc:mysql://127.0.0.1:3306/project2?userSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC")
        ...
        strategyConfig
                ...
                .setInclude("t_seckill_order")// 设置要映射的表
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/demo10/src/main/resources/mapper/"
