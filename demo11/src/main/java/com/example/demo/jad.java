...
public class jad {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/shop?useUnicode=true&characterEncoding=utf8&allowMultiQueries=true&serverTimezone=UTC");
        ...
        strategy.setInclude(scanner("t_brand,t_goods,t_goods_type"));
...
//         自定义 mapper 父类
//         strategy.setSuperMapperClass("com.example.");
////         自定义 service 父类
//         strategy.setSuperServiceClass("com.baomidou.");
////         自定义 service 实现类父类
//         strategy.setSuperServiceImplClass("com.baomidou.");
////         自定义 controller 父类
//         strategy.setSuperControllerClass("com.baomidou.");
